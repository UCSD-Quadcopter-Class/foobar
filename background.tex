...
\label{sec:pl}
\steve{A broader discussion of language design for persistence in general. Rather than just "Rust works great for this", more discussion of what language features are called for, and the ways in which Rust is (or is not) a good fit for those requirements.}
