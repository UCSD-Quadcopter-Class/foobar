...
\newenvironment{goalparttrue}[1]{\begin{discuss}[Design Goal~\ref{#1} (\nameref{#1}) Partially Holds:]}{\end{discuss}}% ignore macros
...
\newcommand*\rotr{\multicolumn{1}{R{40}{2em}|}}% no optional argument here, please!
