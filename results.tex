...
\begin{table}
  ...
  \end{tabular}
  \caption{\textbf{\This's basic operation latency and standard deviation} for durability (excluding DRAM) and safety support measured on different devices. }
...
The BST workload uses failure-atomic instantiation rather than transaction allocation and initialization. This features is not available in Atlas and go-pmem.
